  ...
  return (
   <section id ="home" className='container mx-auto flex flex-col md:flex-row justify-between items-center pt-44  pb-6 px-4 sm:px-6 lg:px-8'>
    <div className='w-full md :w-1/2 space-y-8'>
        <div className='flex items-center gap-2 bg-grey-50 w-fit px-4 py-2 rounded-full hover:bg-gray-100 transition-colors cursor-pointer group'>
        ...
        <p className='text-gray-600 text-lg md:text-xl max-w-xl'>Get the most accurate leads, sales people training and conversation, tools and more -all within the same one billing.</p>

        <div className='flex gap-3 max-w-md'>
            <input type = "email" placeholder='Email Address' className='flex-1 px-6 py-4 border border-gray-200 rounded-xl focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-100 transiiton-all'></input>
    ...
    <div className='w-full md:w-1/2 mt-16 md:mt-0 pl-0 md:pl-12'> 
      <div className='relative'>
        <img src ={heroImage} alt="hero image" className='rounded-lh relative z-10 hover:scale-[1.02] transition-transform duration-300'></img>
      </div>
    </div>
   </section>
  )
