...
const PricingSection = () => {
    const [productCount, setProductCount] = useState(1); // Fixed the setter name here
  ...
  return (
    <section className='py-20 px-4'>
        <div className='max-w-6xl mx-auto'> 
            <h2 className='text-3xl md:text-4xl font-bold text-center mb-16'>Pricing Section </h2>

            <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mb-12'>
                <div className='bg-white p-8 rounded-lg shadow-lg '>
                    <h3 className='text-xl text-gray-500-600 mb-4'>Starter</h3>
                    <p className='text-3xl font-bold mb-6'>${starterPrice}/mo</p>
                </div>

                <div className='bg-white p-8 rounded-lg shadow-lg '>
                    <h3 className='text-xl text-gray-500-600 mb-4'>Business</h3>
